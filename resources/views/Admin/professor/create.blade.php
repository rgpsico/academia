...
<div class="card">
    ...
    <div class="card-body">
<form class="form-horizontal" method="POST" action="{{route('professor.store')}}">
    @csrf
            ...
            <div class="form-group row">
                <label for="nome" class="col-sm-2 col-form-label">Tipo</label>
                    <div class="col-sm-10">
                        <input type="text"  name="tipo" class="form-control @error('tipo') is-invalid @enderror " id="tipo"  value="{{old('tipo')}}">
                    </div>
            </div>
